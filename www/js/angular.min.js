...
return a}function Ke(){this.SCE_CONTEXTS=ka;var b=["self"],a=[];this.resourceUrlWhitelist=function(a){arguments.length&&(b=Yc(a));return b};this.resourceUrlBlacklist=function(b){arguments.length&&(a=Yc(b));return a};this.$get=["$injector",function(c){function d(a,b){return"self"===a?Oc(b):!!a.exec(b.href)}function e(a){var b=function(a){this.$$unwrapTrustedValue=function(){return a}};a&&(b.prototype=new a);b.prototype.valueOf=function(){return this.$$unwrapTrustedValue()};b.prototype.toString=function(){return this.$$unwrapTrustedValue().toString()};
return b}var f=function(a){throw Aa("unsafe");};c.has("$sanitize")&&(f=c.get("$sanitize"));var g=e(),h={};h[ka.HTML]=e(g);h[ka.CSS]=e(g);h[ka.URL]=e(g);h[ka.JS]=e(g);h[ka.RESOURCE_URL]=e(h[ka.URL]);return{trustAs:function(a,b){var c=h.hasOwnProperty(a)?h[a]:null;if(!c)throw Aa("icontext",a,b);if(null===b||b===t||""===b)return b;if("string"!==typeof b)throw Aa("itype",a);return new c(b)},getTrusted:function(c,e){if(null===e||e===t||""===e)return e;var g=h.hasOwnProperty(c)?h[c]:null;if(g&&e instanceof
g)return e.$$unwrapTrustedValue();if(c===ka.RESOURCE_URL){var g=ya(e.toString()),p,r,m=!1;p=0;for(r=b.length;p<r;p++)if(d(b[p],g)){m=!0;break}if(m)for(p=0,r=a.length;p<r;p++)if(d(a[p],g)){m=!1;break}if(m)return e;throw Aa("insecurl",e.toString());}if(c===ka.HTML)return f(e);throw Aa("unsafe");},valueOf:function(a){return a instanceof g?a.$$unwrapTrustedValue():a}}}]}function Je(){var b=!0;this.enabled=function(a){arguments.length&&(b=!!a);return b};this.$get=["$parse","$sniffer","$sceDelegate",function(a,
...
b))return!0;return!1;default:return!1}};switch(typeof a){case "boolean":case "number":case "string":a={$:a};case "object":for(var g in a)(function(b){"undefined"!==typeof a[b]&&e.push(function(c){return f("$"==b?c:c&&c[b],a[b])})})(g);break;case "function":e.push(a);break;default:return b}d=[];for(g=0;g<b.length;g++){var h=b[g];e.check(h,g)&&d.push(h)}return d}}function $c(b){var a=b.NUMBER_FORMATS;return function(b,d){E(d)&&(d=a.CURRENCY_SYM);return null==b?b:dd(b,a.PATTERNS[1],a.GROUP_SEP,a.DECIMAL_SEP,
2).replace(/\u00A4/g,d)}}function bd(b){var a=b.NUMBER_FORMATS;return function(b,d){return null==b?b:dd(b,a.PATTERNS[0],a.GROUP_SEP,a.DECIMAL_SEP,d)}}function dd(b,a,c,d,e){if(!isFinite(b)||R(b))return"";var f=0>b;b=Math.abs(b);var g=b+"",h="",k=[],l=!1;if(-1!==g.indexOf("e")){var n=g.match(/([\d\.]+)e(-?)(\d+)/);n&&"-"==n[2]&&n[3]>e+1?(g="0",b=0):(h=g,l=!0)}if(l)0<e&&-1<b&&1>b&&(h=b.toFixed(e));else{g=(g.split(ed)[1]||"").length;E(e)&&(e=Math.min(Math.max(a.minFrac,g),a.maxFrac));b=+(Math.round(+(b.toString()+
...
[];var P=Array.isArray,X=function(b){return F(b)?b.trim():b},Ua=function(){if(w(Ua.isActive_))return Ua.isActive_;var b=!(!$.querySelector("[ng-csp]")&&!$.querySelector("[data-ng-csp]"));if(!b)try{new Function("")}catch(a){b=!0}return Ua.isActive_=b},ib=["ng-","data-ng-","ng:","x-ng-"],Dd=/[A-Z]/g,lc=!1,Ib,Hd={full:"1.3.0-rc.4",major:1,minor:3,dot:0,codeName:"unicorn-hydrafication"};T.expando="ng339";var rb=T.cache={},Ye=1;T._data=function(b){return this.cache[b[this.expando]]||{}};var Te=/([\:\-\_]+(.))/g,
...
delete n[H],x[H]=M,Z[l]=M;else{if(x[H])throw q(Z,function(a){a&&a.scope&&(n[a.id]=a)}),d("dupes",h,H,ra(J));Z[l]={id:H,scope:t,clone:t};x[H]=!0}for(w in n){M=n[w];H=kb(M.clone);c.leave(H);if(H[0].parentNode)for(l=0,p=H.length;l<p;l++)H[l].$$NG_REMOVED=!0;M.scope.$destroy()}for(l=0;l<z;l++)if(E=g===C?l:C[l],J=g[E],M=Z[l],M.scope){w=I;do w=w.nextSibling;while(w&&w.$$NG_REMOVED);M.clone[0]!=w&&c.move(kb(M.clone),null,y(I));I=M.clone[M.clone.length-1];e(M.scope,l,s,J,v,E,z)}else m(function(a,d){M.scope=
